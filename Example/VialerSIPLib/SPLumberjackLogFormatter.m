...
-(NSString *)formatLogMessage:(DDLogMessage *)logMessage {
    ...
    if ([[[UIDevice currentDevice] systemVersion] compare:@"10" options:NSNumericSearch] == NSOrderedAscending) {
        ...
        // Remove timestamp to avoid double timestamp in iOS >= 10
        return [NSString stringWithFormat:@"%@ [%@ %@%tu] %@", logLevel, fileName, function, logMessage->_line ,logMessage->_message];
    }
