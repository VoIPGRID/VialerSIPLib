...
/**
 Maximum calls to support . The value specified here must be smaller than the compile time maximum settings PJSUA_MAX_CALLS,
...
/**
 Additional flags to be given to pj_file_open() when opening the log file. By default, the flag is PJ_O_WRONLY.
...
/**
 Clock rate to be applied to the conference bridge. If value is zero, default clock rate will be used (PJSUA_DEFAULT_CLOCK_RATE).
 Default value: 1600
 */
